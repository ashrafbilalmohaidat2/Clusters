        ...
        <section className="mb-16">
          <div className="bg-white rounded-3xl p-8 border border-[#66D9EF]/20 shadow-xl">
            <h2 className="text-3xl font-bold text-[#1A1A3A] mb-4 flex items-center">
              ...
              {t("page.uiux.toolsTechnologies.title")}
            </h2>
            <p className="text-gray-600 mb-8 text-lg leading-relaxed">{t("page.uiux.toolsTechnologies.description")}</p>
            
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {(Array.isArray(t("page.uiux.toolsTechnologies.tools", { returnObjects: true })) ? t("page.uiux.toolsTechnologies.tools", { returnObjects: true }) : []).map((tool, i) => (
        ...
        <section className="mb-16">
          <div className="bg-white rounded-3xl p-8 border border-[#66D9EF]/20 shadow-xl">
            ...
            <div className="space-y-6">
              {(Array.isArray(t("page.uiux.ourProcess.steps", { returnObjects: true })) ? t("page.uiux.ourProcess.steps", { returnObjects: true }) : []).map((step, i) => (
