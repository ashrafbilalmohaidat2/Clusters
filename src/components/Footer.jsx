...
const Footer = () => {
  ...
  const socialLinks = [
  { name: "Facebook", icon: <svg className="transition-all duration-300 group-hover:scale-110"
      ...
      </svg>, url: "https://www.facebook.com/share/14KZezKY8FR/" },
  { name: "Instagram", icon: <svg className="transition-all duration-300 group-hover:scale-110" width="28" height="28" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <stop offset="1" stopColor="#8C3AAA"/>
        ...
        </svg>, url: "https://www.instagram.com/clustersjo/" },
  { name: "LinkedIn", icon: <svg className="rounded-md transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
          ...
          </svg>, url: "https://www.linkedin.com/company/clustersjo/" },
  ];
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 font-medium">
              <li className="hover:text-[#00AEEF] cursor-pointer" ><a href="mailto:clusters.jo79@gmail.com">clusters.jo79@gmail.com</a></li>
            </ul>
          </div>
        </div>
